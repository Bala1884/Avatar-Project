...
export default function Csgo(props) {
  const { scene } = useGLTF('./models/Professionalmiami.glb')
  const clone = React.useMemo(() => SkeletonUtils.clone(scene), [scene])
  const { nodes, materials } = useGraph(clone)
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, -Math.PI / 2]} scale={0.025}>
        <primitive object={nodes.pelvis} rotation={[0, Math.PI / 2, 0]} scale={[4.5,4.5,4.5]} />
...
useGLTF.preload('./models/Professionalmiami.glb')
