...
Command: npx gltfjsx@6.5.0 D:\Bala\Avatar chatbot\Avatar project\public\models\hi_girl.glb 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF('/hi_girl.glb')
